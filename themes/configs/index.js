...
const themes = {
  ...
  term: full("term", "Term",
    "Terminal aesthetic. Black field, green phosphor glow, CRT scanlines. The anti-Y2K: raw retro computing instead of glossy optimism.",
  ...
  bloons: full("bloons", "Bloons",
    "Bright saturated tower-defense energy. Sky blue, banana yellow, and round cartoon shapes — a deliberate contrast to the dark themes.",
    300000, 5, "🎈", bloonsColors,
    {
      slots: {
        // No custom sprite sheet yet — falls back to classic default sprites
        // until bloons.png lands in imgs/slots.
        reelBackground:      "rgba(230, 244, 255, 0.85)",
        frameColor:          "#ffe135",
        frameDarkColor:      "#daa520",
        frameBronze:         "#a67c00",
        dividerColor:        "#50a0dc",
        highlightWin:        "rgba(102, 255, 102, 0.45)",
        bannerBackground:    "#3a7ba8",
        bannerBackgroundEnd: "#2a5f8f",
        motionBlurOverlay:   "rgba(80, 160, 220, 0.45)",
        paylineColors:       ["#ff4444", "#4488ff", "#66ff66", "#ffe135", "#ff88cc"],
      },
      roulette: {
        woodInner:       "#8fc4e8",
        woodMid:         "#6aa8d8",
        ...
        goldRim:         "#ffe135",
        pocketRed:       "#ff4444",
        // Navy rather than black — true black would break the bright scheme.
        pocketBlack:     "#2a5f8f",
        pocketGreen:     "#4caf50",
        ...
        betArea:         "#62b0e4",
        betBorder:       "#ffe135",
        resultOverlay:   "rgba(26, 60, 92, 0.82)",
        resultBorder:    "#ffe135",
      },
      craps: {
        feltInner:        "#62b0e4",
        ...
        layoutLine:       "#ffe135",
        layoutLabel:      "#ffffff",
        passLineColor:    "#4caf50",
        dontPassColor:    "#c0392b",
        fieldColor:       "#8fc4e8",
        comeColor:        "#62b0e4",
        placeColor:       "#50a0dc",
        hardWaysColor:    "#ff4444",
        propsColor:       "#ff88cc",
        bigSixEightColor: "#50a0dc",
        puckOff:          "#2a5f8f",
        puckOn:           "#ffe135",
        puckText:         "#1a0a04",
        diceFace:         "#ffffff",
        diceDots:         "#1a0a04",
        winnerHighlight:  "#66ff66",
        resultOverlay:    "rgba(26, 60, 92, 0.82)",
        resultBorder:     "#ffe135",
      },
  ...
  marble: styled("marble", "Marble",
    ...
    {
      slots: {
        reelBackground:      "rgba(200, 200, 200, 0.75)",
        frameColor:          "#c8a868",
        frameDarkColor:      "#a08050",
        frameBronze:         "#786038",
        dividerColor:        "#d0d0d0",
        highlightWin:        "rgba(68, 170, 68, 0.5)",
        bannerBackground:    "#d0d0d0",
        bannerBackgroundEnd: "#b8b8b8",
        motionBlurOverlay:   "rgba(200, 200, 200, 0.4)",
        paylineColors:       ["#c8a868", "#44aa44", "#cc4444", "#88aacc", "#aa88cc"],
      },
      roulette: {
        textWhite: "#ffffff",
      },
  ...
  storm: styled("storm", "Storm",
    ...
    {
      slots: {
        reelBackground:      "rgba(42, 46, 50, 0.75)",
        frameColor:          "#c0c8d0",
        frameDarkColor:      "#889098",
        frameBronze:         "#586068",
        dividerColor:        "#2a2e32",
        highlightWin:        "rgba(136, 255, 136, 0.45)",
        bannerBackground:    "#2a2e32",
        bannerBackgroundEnd: "#1e2226",
        motionBlurOverlay:   "rgba(48, 52, 56, 0.5)",
        paylineColors:       ["#c0c8d0", "#88ff88", "#ff6666", "#ffff88", "#88ccff"],
      },
    },
  ),
  ...
  sakura: styled("sakura", "Sakura",
    ...
    {
      slots: {
        reelBackground:      "rgba(248, 220, 230, 0.75)",
        frameColor:          "#e8a8b8",
        frameDarkColor:      "#c88898",
        frameBronze:         "#a86878",
        dividerColor:        "#f0c8d8",
        highlightWin:        "rgba(136, 204, 136, 0.5)",
        bannerBackground:    "#f0c8d8",
        bannerBackgroundEnd: "#e8b8c8",
        motionBlurOverlay:   "rgba(255, 220, 230, 0.4)",
        paylineColors:       ["#e8a8b8", "#88cc88", "#cc5555", "#f5d042", "#aa88cc"],
      },
      roulette: {
        textWhite: "#ffffff",
      },
  ...
  coral: styled("coral", "Coral",
    ...
    {
      slots: {
        reelBackground:      "rgba(140, 70, 48, 0.75)",
        frameColor:          "#f5c070",
        frameDarkColor:      "#c89850",
        frameBronze:         "#a07838",
        dividerColor:        "#8a4830",
        highlightWin:        "rgba(136, 255, 170, 0.45)",
        bannerBackground:    "#8a4830",
        bannerBackgroundEnd: "#6e3a28",
        motionBlurOverlay:   "rgba(180, 90, 60, 0.5)",
        paylineColors:       ["#f5c070", "#88ffaa", "#ff5555", "#ffcc88", "#88ccff"],
      },
    },
  ),

  bloodMoon: styled("bloodMoon", "Blood Moon",
    "A low red moon over a black horizon. Deep crimson with aged gold rims — Halloween atmosphere that never leaves the shop.",
